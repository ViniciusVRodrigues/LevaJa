/**
 * Testes de Arquitetura - function-produtos-auditoria
...
describe('Arquitetura da function-produtos-auditoria - Clean Architecture', () => {
  ...
  test('Cada Function deve ter responsabilidade única e clara', () => {
    ...
    const hasRelatorioFunction = functionDirs.some(f => f.includes('Relatorio'));
    
    expect(hasProcessFunction || hasGetFunction || hasRelatorioFunction).toBe(true);
  });
...
describe('Vertical Slice Architecture - function-produtos-auditoria', () => {
  ...
  test('Cada feature/endpoint deve ter sua própria Function isolada', () => {
    ...
    // Ex: ProcessLoteCriado, GetProdutosAuditoria, GetRelatorioEstoqueBaixo
